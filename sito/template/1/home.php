<div class="container">
	...
	<?php if(!empty($articoli)){ ?>
		<div class="col mb-5">
			<div class="p-4 mb-3 text-white rounded" style="background-color: #9CB4CC;">
	...
	<?php if(!is_null($ultimo_articolo)){?>
		...
		<div class="mt-4 p-4 p-md-5 mb-4 text-white rounded" style="background-color: #9CB4CC;">
			<div class="col-md-6 px-0">
				<h1 class="display-4 text-capitalize"><?=$ultimo_articolo["titolo_articolo"]?></h1>
	...
	<div class="row">
		...
		?>
		<div class="col-md-6">
			<div class="row g-0 rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative" style="background-color: #9CB4CC;">
	...
	<div class="row g-5 p-5 justify-content-between">
		<?php if(!empty($articoli)){ ?>
			...
			<div class="col-md-9">
				...
				<?php foreach($articoli as $k=>$valore){?>
					<article class="rounded text-white p-5" style="box-shadow: 0px 4px 10px 2px #999; background-color: #9CB4CC;">
						<div class="row">
							<div class="col">
						...
						<div class="row">
							<div class="col">
								<span class="ps-4 pe-4">
									...
									<br/>
									<a class="text-black" href="/blog/<?=$data["indirizzo_blog"]?>/articolo/<?=$valore["id"]?>"> 
										Continua a leggere...		
									</a>
								</span>
							</div>
		...
		<?php } else {  ?>
			<div class="col-12 text-center">
					<?php if($autore){ 
						...
						echo '<a class="btn btnl-lg btn-outline-primary" href="/blog/'.$data["indirizzo_blog"].'/article_editor">Scrivi un articolo!</a>';
